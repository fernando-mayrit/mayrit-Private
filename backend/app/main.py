...
from .routers import avisos, bdx, binders, cierre, claims_bdx, codigos_postales, comisiones, consultoria, lpan, maestras, ramos, recibos, siniestros, tareas, triangulacion
