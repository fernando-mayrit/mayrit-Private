...
MAPEO: dict[str, str] = {
    ...
    "risk_code": ["Risk Code", "Risk Code (see list)"],
    ...
    "insured_id": ["ID Insured/Policyholder", "Spanish tax identification number"],
    "insured_address": "Insured Address",
    "insured_province": ["Insured Country Sub-division: State, Province, Territory, Canton", "Insured Country Sub-division: State, Province, Territory, Canton etc", "Insured Country Sub-division: Province"],
    "insured_postcode": ["Insured Postcode, Zip Code or Similar", "Insured Postcode"],
    "insured_country": ["Insured Country (see code list)", "Insured Country (ISO code list)", "Insured Country"],
    # Riesgo
    ...
    "location_risk_province": ["Location of Risk - Country Sub-division: State, Province, Territ", "Location of Risk - Country Sub-division: State, Province, Territory, Canton etc"],
    ...
    # Impuestos 1–4
    "tax1_jurisdiction": ["Tax 1 - Jurisdiction: Country, Province", "Tax 1 - Jurisdiction: Country, State, Province, Territory", "Tax 1 - Jurisdiction"],
    ...
    "tax2_jurisdiction": ["Tax 2 - Jurisdiction: Country, Province", "Tax 2 - Jurisdiction: Country, State, Province, Territory", "Tax 2 - Jurisdiction"],
