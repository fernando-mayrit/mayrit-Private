...
export interface BinderLimite {
  ...
  estado?: "verde" | "ambar" | "rojo" | "informado" | null; // consumo de este límite (solo lectura)
...
export interface Binder extends BinderComun {
  ...
  notif_estado: "verde" | "ambar" | "rojo" | "informado" | null; // semáforo del límite más crítico
