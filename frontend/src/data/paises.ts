// Lista de países (en español) para el selector. España primero (caso más habitual).
export const PAISES: string[] = [
  "España",
  "Afganistán", "Albania", "Alemania", "Andorra", "Angola", "Arabia Saudí", "Argelia",
  "Argentina", "Armenia", "Australia", "Austria", "Azerbaiyán", "Bahamas", "Bangladés",
  "Barbados", "Baréin", "Bélgica", "Belice", "Benín", "Bielorrusia", "Bolivia",
  ...
  "Chile", "China", "Chipre", "Colombia", "Comoras", "Corea del Norte", "Corea del Sur",
  ...
  "Micronesia", "Moldavia", "Mónaco", "Mongolia", "Montenegro", "Mozambique", "Birmania",
