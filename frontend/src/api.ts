...
export interface Tarea {
  ...
  n_pasos: number;
  proxima?: string | null;
  proxima_periodo?: string | null;   // mes del dato de la próxima pendiente ('YYYY-MM')
...
export const tareasApi = {
  ...
  copiarAnterior: (binderId: number) => request<{ tareas: number; pasos: number; config: number; desde_binder_id: number; desde_binder_umr: string | null }>(`/binders/${binderId}/tareas/copiar-anterior`, { method: "POST" }),
