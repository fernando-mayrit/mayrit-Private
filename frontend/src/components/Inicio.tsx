...
const FRASES = [
  ...
  "Que hoy los recibos se concilien casi solos. 🧮",
  "Cada LPAN en su sitio y el mes bien cerrado. 📋",
  "Detrás de cada prima, un cliente tranquilo. 😌",
  "Paso a paso, el binder se cierra. ✅",
  "Cierra el mes con la cabeza bien alta. 🏆",
  "Cada tarea marcada, un peso menos. 🎯",
  "Buenos datos, mejores decisiones. 💡",
  "Suma tranquilidad, resta preocupaciones. ➕",
  "Hoy el mercado juega a tu favor. 📊",
  "Confianza que se renueva cada año. ♻️",
  "Un mercado, mil oportunidades. 🌍",
  "Que la suerte acompañe al buen trabajo. 🍀",
  "Cada binder, una historia bien llevada. 🔑",
  "Con orden, hasta el cierre es más fácil. 🧩",
  "Hoy también vas a dejarlo todo cuadrado. ⚡",
  "Siembra buenos acuerdos, recoge clientes fieles. 🌱",
  "El café primero; los siniestros, después. ☕",
  "Que ningún recibo se te resista. 💪",
  "Otra jornada para hacerlo bien. 🌅",
];
